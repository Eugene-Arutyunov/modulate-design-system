...
.recommendations{margin:0 0 48px;scroll-margin-top:24px}.issues-table{width:100%;table-layout:fixed;border-collapse:collapse}.issues-table th,.issues-table td{text-align:left;vertical-align:top;padding:16px;border-bottom:1px solid #d9d8e0;overflow-wrap:anywhere}.issues-table th:first-child{width:24%}.issues-table thead th:nth-child(2){width:28%}.issues-table tr{scroll-margin-top:24px}.issues-table td:nth-child(2)>code{color:#30934d}.issues-table td:nth-child(3)>code{color:#dc1e3a}.issues-table td>code{background:color-mix(in srgb,currentColor 15%,transparent);border-color:color-mix(in srgb,currentColor 25%,transparent);box-decoration-break:clone;-webkit-box-decoration-break:clone}.style-values{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:16px}.recommendation-fix{padding:16px;background:#f2f2f6;border-radius:8px}.differences{margin-top:16px}article,.state{scroll-margin-top:24px}
