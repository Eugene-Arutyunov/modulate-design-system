  ...
  content.innerHTML = `
    <div class="m__code-block">
      <div class="m__code-block__toolbar">
        ...
        <button class="m__button-secondary-outline S" id="docs-download-btn">Download</button>
      </div>
  ...
  content.innerHTML = `
    <div class="docs-panel">
      <div class="docs-panel__toolbar">
        ...
        <button class="m__button-secondary-outline S" id="docs-quickstart-download-btn">Download</button>
      </div>
